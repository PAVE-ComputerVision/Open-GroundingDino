...
#                        break
    ...
    if args.eval:
        ...
        test_stats, coco_evaluator = evaluate(model, criterion, repvit_model, rep_eval_on_format_results, rep_eval_kwargs, postprocessors, data_loader_val, base_ds, device, args.output_dir, wo_class_error=wo_class_error, args=args)
        if args.output_dir:
